    ...
    <div className="min-h-screen bg-gray-100 p-3">
      ...
      <div className="grid grid-cols-4 gap-6">
        <div className='col-span-1'>
          ...
          <div className="bg-green-200 mb-4 p-6 max-h-96 overflow-y-scroll scrollabler scrollable-hover rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <div className='col-span-1'>
          {/* AI Assistant Chat */}
          <div className="mb-5 max-h-96 h-48 overflow-y-scroll scrollabler scrollable-hover bg-white p-4 rounded-lg shadow-md">
